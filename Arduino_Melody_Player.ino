...
void loop() {
  ...
  if (digitalRead(buttonPin) == LOW) {
    tone(speakerPin, NOTE_E7, 120); // Play the note on the piezo
  ...
  if (digitalRead(buttonPin2) == LOW) {
    tone(speakerPin, NOTE_C7, 120); // Play the note on the piezo
  ...
  if (digitalRead(buttonPin3) == LOW) {
    tone(speakerPin, NOTE_G7, 120); // Play the note on the piezo
  ...
  if (digitalRead(buttonPin4) == LOW) {
    tone(speakerPin, NOTE_G6, 120); // Play the note on the piezo
